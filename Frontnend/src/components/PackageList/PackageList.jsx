...
const PackageList = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/api/packages')
      .then(res => {
        const safariPackages = res.data.filter(pkg =>
          pkg.type && pkg.type.trim().toLowerCase() === 'safari'
        );
  ...
  // ✅ Static image, description, and link mappings
  const packageImages = {
    1: ["/assets/PackagePhotos/Kumana1.jpg", "/assets/PackagePhotos/Kumana2.JPG", "/assets/PackagePhotos/Kumana3.jpg", "/assets/PackagePhotos/Kumana4.jpg"],
    ...
    7: ["/assets/PackagePhotos/Custom1.jpg", "/assets/PackagePhotos/Custom2.png", "/assets/PackagePhotos/Custom3.webp", "/assets/PackagePhotos/Custom4.jpg"],
    ...
    10: ["/assets/PackagePhotos/Okanda1.jpg", "/assets/PackagePhotos/Okanda2.jpg", "/assets/PackagePhotos/Okanda3.jpg", "/assets/PackagePhotos/Okanda4.jpg"],
  ...
  const packageDescriptions = {
    ...
    3: ["Enjoy a safe, private airport transfer to or from Arugam Bay in an air-conditioned car with professional driver and flexible timings."],
  ...
  const sortedPackages = [...packages].sort((a, b) => {
    const priority = {
      "Kumana National Park Safari Tour": 1,
      "Camping in Kumana": 2,
    };
    return (priority[a.packageName] || 99) - (priority[b.packageName] || 99);
  });

  const headerColor = '#010f02ff';
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-5">
        <h6 className="text-muted mb-2" style={{ letterSpacing: "2px" }}>
          KUMANA WILD TRAILS
        </h6>
        <h1
          style={{
          ...
          return (
            ...
            >
              <Card className="shadow-lg border-0 rounded-4 overflow-hidden h-100">
                <Carousel interval={isVisible ? 3000 : null} fade>
                  {images.map((img, idx) => (
                ...
                >
                  <div>
                    <Card.Title
                      ...
                      style={{ fontSize: '1.5rem', fontWeight: 600, color: '#002e13' }}
                    >
                      {pkg.packageName}
                    </Card.Title>
                    ...
                    <Card.Text
                      ...
                      style={{ fontSize: '0.95rem', minHeight: '80px' }}
                    >
                      {desc.map((line, i) => (
