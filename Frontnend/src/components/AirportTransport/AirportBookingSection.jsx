    ...
    >
      ...
      <div className="row m-0 pb-4 px-2 px-md-3 justify-content-center align-items-stretch">
        ...
        <div className="col-lg-7 col-md-12 d-flex flex-column mb-4">
              ...
              {[1, 2, 3, 4].map((imgNum) => (
                <Carousel.Item key={imgNum}>
                  <img
                    ...
                    src={`/assets/PackagePhotos/Airport${imgNum}.jpg`}
                    alt={`Slide ${imgNum}`}
                    style={{
                      height: '500px',
                      objectFit: 'cover',
          ...
          >
            <p className="mb-0">
             Enjoy peace of mind and maximum comfort with our private airport transfer service to or from Arugam Bay. Ride in a modern, air-conditioned vehicle with a courteous, professional driver who ensures a smooth and safe journey tailored to your schedule. Whether you're arriving for a beach holiday or heading back home, this flexible transfer option eliminates stress and guarantees a relaxed travel experience. Enjoy scenic views along the route and optional rest stops, making this the most convenient and comfortable way to reach your destination.
              </p>
          </div>
        </div>
        ...
        <div className="col-lg-5 col-md-12 d-flex justify-content-center align-items-center">
          <div className="w-100" style={{ maxWidth: '500px' }}>
            <AirportBookingForm packageDetails={packageDetails} />
          </div>
        </div>
      </div>
    </div>
...
export default AirportHomeSection;
