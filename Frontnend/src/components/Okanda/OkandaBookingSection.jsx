...
const customImagePaths = [
  "/assets/PackagePhotos/Okanda1.jpg",
  "/assets/PackagePhotos/Okanda2.jpg",
  "/assets/PackagePhotos/Okanda3.webp",
  "/assets/PackagePhotos/Okanda4.webp",
];

const OkandaBookingSection = () => {
  ...
  {customImagePaths.map((imgPath, index) => (
    <Carousel.Item key={index}>
      ...
      />
          ...
          >
            <p className="mb-0">
             Journey to Sri Lanka’s southeastern coast and discover the spiritual charm of Okanda Temple. This revered site, known for its cultural significance and coastal beauty, invites visitors to explore its legends, shrines, and peaceful surroundings. Wander through temple grounds, hear stories of pilgrimages and deities, and enjoy sweeping views of the Indian Ocean. Ideal for culture lovers and curious travelers, this half-day tour offers insight, tranquility, and a deeper appreciation of local traditions.
...
export default OkandaBookingSection;
