    ...
    >
      ...
      <div className="row m-0 pb-4 px-2 px-md-3 justify-content-center align-items-stretch">
        ...
        <div className="col-lg-7 col-md-12 d-flex flex-column mb-4">
              ...
              {[1, 2, 3, 4].map((imgNum) => (
                <Carousel.Item key={imgNum}>
                  <img
                    ...
                    src={`/assets/PackagePhotos/Ella${imgNum}.jpg`}
                    alt={`Slide ${imgNum}`}
                    style={{
                      height: '500px',
                      objectFit: 'cover',
          ...
          >
            <p className="mb-0">
             Travel through Sri Lanka’s scenic countryside with our private transfer service from Arugam Bay to Ella. Your personal driver will guide you in a comfortable, air-conditioned vehicle through picturesque landscapes, lush hills, and rural villages. Customize the journey with photo stops at waterfalls or tea plantations, or enjoy quiet moments watching the changing scenery. Whether you’re heading into the hill country or simply transitioning between adventures, this transfer blends comfort, flexibility, and stunning views into one memorable ride.
              </p>
          </div>
        </div>
...
export default EllaBookingSection;
