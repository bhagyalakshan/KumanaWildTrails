...
const AncientBookingForm = ({ packageDetails }) => {
...
const [loading, setLoading] = useState(false);
  ...
  return (
    <div className="w-100" style={{ maxWidth: '500px' }}>
      <div className="d-flex justify-content-center align-items-center gap-5 p-3 mb-4" style={{
        backgroundColor: '#f8fdfd',
        borderRadius: '20px',
        boxShadow: '0 0 10px rgba(0,0,0,0.05)',
      }}>
        <div className="text-center">
          <div className="rounded-circle d-flex justify-content-center align-items-center mb-1"
            style={{ width: '40px', height: '40px', backgroundColor: '#d3f1f1' }}>
      ...
      <div className="text-center mb-3 p-3 rounded-3"
        style={{ color: '#006400', backgroundColor: '#f8f9fa', fontWeight: 'bold', fontSize: '1.1rem', border: '3px solid #FFA500' }}>
        ...
        <div className="row g-2 flex-grow-1">
          ...
          <div className="col-md-6">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light"><i className="bi bi-person-fill text-secondary"></i></span>
          ...
          <div className="col-md-6">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light"><i className="bi bi-envelope-fill text-secondary"></i></span>
          ...
          <div className="col-md-4">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light"><i className="bi bi-telephone-fill text-secondary"></i></span>
          ...
          <div className="col-md-4">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light"><i className="bi bi-person text-secondary"></i></span>
          ...
          <div className="col-md-4">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light"><i className="bi bi-people text-secondary"></i></span>
          ...
          <div className="col-md-6">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light"><i className="bi bi-calendar-event-fill text-secondary"></i></span>
              <input type="date" name="safariDate" className="form-control" value={formData.safariDate} onChange={handleChange} min={getTodayDateString()} required />
            </div>
          </div>
          ...
          <div className="col-12 mb-2">
            ...
            <textarea name="specialRequests" className="form-control" rows="4" value={formData.specialRequests} onChange={handleChange}></textarea>
          </div>
...
export default AncientBookingForm;
